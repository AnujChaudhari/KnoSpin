    ...
    <div className="px-4 md:px-8 max-w-7xl mx-auto">
      ...
      >
        <div className="space-y-4">
          ...
          <a href="/products?filter=sale" className="inline-block bg-white text-primary-600 font-semibold px-6 py-3 rounded-full mt-4 hover:bg-gray-100 transition">
            Shop Now
          </a>
        </div>
        <img src="https://res.cloudinary.com/demo/image/upload/v1/samples/shoe.jpg" alt="hero" className="w-60 md:w-80 mt-6 md:mt-0 rounded-2xl" />
      </motion.section>
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 snap-x">
            {categories.map(cat => (
              <a key={cat.id} href={`/products?category=${cat.id}`} className="glassmorphism min-w-[120px] p-4 rounded-xl flex flex-col items-center text-center snap-start">
                <img src={cat.image || 'https://res.cloudinary.com/demo/image/upload/v1/samples/landscapes/beach-boat.jpg'} className="w-12 h-12 rounded-full object-cover mb-2" />
